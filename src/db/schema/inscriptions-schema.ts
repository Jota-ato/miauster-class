...
export const inscriptions = pgTable("inscriptions", {
    ...
    creatorNameSnapshot: varchar("creator_name_snapshot", { length: 50 }).notNull(),
    studentNameSnapshot: varchar("student_name_snapshot", { length: 50 }).notNull(),
    groupNameSnapshot: varchar("group_name_snapshot", { length: 20 }).notNull(),
    groupStartDateSnapshot: date("group_start_date_snapshot", { mode: "string" }).notNull(),
