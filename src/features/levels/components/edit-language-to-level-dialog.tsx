...
} from "@/features/languages/types/languages.types";
import { EditLanguageToLevelForm } from "./edit-language-to-level-form";
    ...
    <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Selecciona el idioma que deseas agregar a este nivel. Una vez
            agregado, podrás crear grupos con este nivel e idioma.
          </DialogDescription>
        </DialogHeader>
        <EditLanguageToLevelForm
          level={level}
